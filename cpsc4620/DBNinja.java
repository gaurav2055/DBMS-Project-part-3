...
//				}
				...
				switch (newState) {
					case PREPARED:
						// Mark the order as complete
						String orderSQL = "UPDATE ordertable SET ordertable_IsComplete = 1 WHERE ordertable_OrderID = ?";
					...
					case PICKEDUP:
						// Update pickup status
						String pickupSQL = "UPDATE pickup SET pickup_IsPickedUp = 1 WHERE ordertable_OrderID = ?";
